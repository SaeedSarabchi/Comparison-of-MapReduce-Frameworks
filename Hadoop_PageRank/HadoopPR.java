...
/*
 * Haejoon Lee modified PageRank Code on 2015.01.17 
 * Reference File: https://code.google.com/p/haloop/source/browse/
 */

public class HadoopPR {
	...
	public static class ComputeRankReduce extends MapReduceBase implements
		...
		public void reduce(TextPair key, Iterator<Text> values,
			...
			String countRank = Integer.toString(count);
			byte[] cntBytes = countRank.getBytes();
			value.append(cntBytes, 0, cntBytes.length);
			output.collect(key.getFirst(), value);
		}
	}
	...
	public static void main(String[] args) throws Exception {
		 ...
		 */
		JobConf conf = new JobConf(HadoopPR.class);
		...
		conf.setNumReduceTasks(numReducers);
                        conf.setJar("pr.jar");
                        conf.setJarByClass(HadoopPR.class);
